...
{
    /// <summary>
    /// Consumes integration events in BookingCancelledConsumer.
    /// </summary>
    public class BookingCancelledConsumer : IConsumer<BookingCancelledEvent>
    {
        ...
        public async Task Consume(ConsumeContext<BookingCancelledEvent> context)
        {
            ...
            var body = BuildBookingCancelledEmail(msg);
        ...
        private static string BuildBookingCancelledEmail(BookingCancelledEvent msg)
        {
          ...
          <table role='presentation' width='640' cellspacing='0' cellpadding='0' style='width:100%;max-width:640px;background:#ffffff;border:1px solid #dce5f0;border-radius:14px;overflow:hidden;'>
            <tr>
              <td style='padding:22px 24px;background:linear-gradient(120deg,#0f766e 0%,#115e59 100%);color:#ffffff;'>
                ...
                <h1 style='margin:10px 0 4px;font-size:26px;line-height:1.2;'>Your booking has been cancelled</h1>
                <p style='margin:0;font-size:15px;opacity:0.95;'>This reservation is no longer active.</p>
              </td>
            </tr>
            <tr>
                ...
                <table role='presentation' width='100%' cellspacing='0' cellpadding='0' style='border:1px solid #e7edf5;border-radius:10px;background:#f8fbff;'>
                  ...
                  <tr>
                    <td style='padding:0 18px 8px;'>
                      <p style='margin:0;font-size:15px;color:#334e68;'><strong>Room:</strong> {roomType}</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style='padding:0 18px 18px;'>
                      ...
                      <p style='margin:8px 0 0;font-size:14px;color:#334e68;'><strong>Cancelled by:</strong> {cancelledBy}</p>
                    </td>
                  </tr>
                </table>

                <p style='margin:18px 2px 0;font-size:14px;color:#48627a;line-height:1.6;'>
                  If this cancellation was not expected, please contact support with your booking ID.
                </p>
              </td>
            </tr>
            <tr>
